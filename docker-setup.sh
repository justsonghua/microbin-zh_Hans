...
mkdir -p $install_dir
cd $install_dir
$download_command https://raw.githubusercontent.com/justsonghua/microbin-zh_Hans/master/.env
$download_command https://raw.githubusercontent.com/justsonghua/microbin-zh_Hans/master/compose.yaml
